...
//  private Command autonomousCommand, operatorControl;
  ...
  public void robotInit() {
    ...
    /******************************************** ADD COMMANDS HERE ********************************************/
    CommandGroup fiveft = new CommandGroup();
    
    try {
		fiveft.addSequential(new DistanceDrive(152.6, 1.0, 1.0));
		fiveft.addSequential(new DistanceDrive(152.6, -1.0, -1.0));
	} catch(Exception e) {
    ...
    Scheduler.getInstance().add(fiveft);
    /*********************************** FINISH ADDING COMMANDS BEFORE HERE ************************************/
  }

  /**
   * This function is called every robot packet, no matter the mode. Use
   * this for items like diagnostics that you want ran during disabled,
   * autonomous, tele-operated and test.
   *
